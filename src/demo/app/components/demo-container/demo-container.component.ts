...
@Component({
    ...
    imports: [
        ...
        MatTabsModule,
        // Controls
        ButtonDemoComponent, ButtonValidationComponent, ButtonCodeComponent, ButtonApiComponent,
        InputDemoComponent, InputValidationComponent, InputCodeComponent, InputApiComponent,
        SelectDemoComponent, SelectValidationComponent, SelectCodeComponent, SelectApiComponent,
        CheckboxDemoComponent, CheckboxValidationComponent, CheckboxCodeComponent, CheckboxApiComponent,
        RadioDemoComponent, RadioValidationComponent, RadioCodeComponent, RadioApiComponent,
        RadioGroupDemoComponent, RadioGroupValidationComponent, RadioGroupCodeComponent, RadioGroupApiComponent,
        ChipsDemoComponent,
        ToggleDemoComponent, ToggleValidationComponent, ToggleCodeComponent, ToggleApiComponent,
        TextareaDemoComponent, TextareaValidationComponent, TextareaCodeComponent, TextareaApiComponent,
        SliderDemoComponent, SliderValidationComponent, SliderCodeComponent, SliderApiComponent,
        AutocompleteDemoComponent, AutocompleteValidationComponent, AutocompleteCodeComponent, AutocompleteApiComponent,
        DatepickerDemoComponent, DatepickerValidationComponent, DatepickerCodeComponent, DatepickerApiComponent,
        RangeSliderDemoComponent, RangeSliderValidationComponent, RangeSliderCodeComponent, RangeSliderApiComponent,
        SwitchDemoComponent, SwitchValidationComponent, SwitchCodeComponent, SwitchApiComponent,
        FileInputDemoComponent, FileInputValidationComponent, FileInputCodeComponent, FileInputApiComponent,
        TimepickerDemoComponent, TimepickerValidationComponent, TimepickerCodeComponent, TimepickerApiComponent,
        ColorPickerDemoComponent, ColorPickerValidationComponent, ColorPickerCodeComponent, ColorPickerApiComponent,
        // Components
        CardDemoComponent, CardValidationComponent, CardCodeComponent, CardApiComponent,
        DialogDemoComponent, DialogValidationComponent, DialogCodeComponent, DialogApiComponent,
        SidenavDemoComponent, SidenavValidationComponent, SidenavCodeComponent, SidenavApiComponent,
        PopoverDemoComponent, PopoverValidationComponent, PopoverCodeComponent, PopoverApiComponent,
        DataTableDemoComponent, DataTableValidationComponent, DataTableCodeComponent, DataTableApiComponent,
        CalendarDemoComponent, CalendarValidationComponent, CalendarCodeComponent, CalendarApiComponent,
        StepperDemoComponent, StepperValidationComponent, StepperCodeComponent, StepperApiComponent,
