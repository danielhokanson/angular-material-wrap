    ...
    navigationItems: SidenavItem[] = [
        {
            ...
            children: [
                ...
                { id: 'button-toggle', label: 'Button Toggle', route: '/controls/button-toggle', icon: 'toggle_on' },
                { id: 'checkbox', label: 'Checkbox', route: '/controls/checkbox', icon: 'check_box' },
                { id: 'chip', label: 'Chip', route: '/controls/chip', icon: 'sell' },
                ...
                { id: 'icon-button', label: 'Icon Button', route: '/controls/icon-button', icon: 'touch_app' },
        ...
        },
        {
            ...
            children: [
                ...
                { id: 'badge', label: 'Badge', route: '/components/badge', icon: 'verified' },
                ...
                { id: 'list', label: 'List', route: '/components/list', icon: 'list' },
                { id: 'paginator', label: 'Paginator', route: '/components/paginator', icon: 'last_page' },
