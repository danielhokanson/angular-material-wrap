...
export class SignalFormsApiComponent {
    ...
    readonly importStatement = `import { form, Field } from '@angular/forms/signals';
import { Validators } from '@angular/forms';`;

    readonly usageNotes: string[] = [
        'Signal Forms are experimental and may change in future Angular releases',
        'The [field] binding is mutually exclusive with ngModel and formControl',
        'disabled and required states are automatically derived from the Field',
